...
private:	
	...
	void BuildMesh(const UStaticMesh& mesh, TArray<FVector> buildArea, uint8 inStoreys, RealtimeMesh::FRealtimeMeshStreamSet& streamSet, int amount = -1, bool removeCorners = false);

	void BuildMeshGrid(const UStaticMesh& mesh, TArray<FVector> buildArea, RealtimeMesh::FRealtimeMeshStreamSet& streamSet);
